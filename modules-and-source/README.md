...
This directory contains compiled modules used by the main application.
...
- **CF模块.e** (CF Module): A modified version of the Jingyi (精易) module with additional components.
